...
/* 
	...
	* Uma lista ordenada de valores. Na maioria das linguagens, isso é implementado como arrays. 
	...
	JSON - pode representar quatro tipos primitivos (strings, números, booleanos e valores nulos)
	...
	"
		O pacote JSON é uma lib que nos permite transformar estruturas e tipos de dados em GO
